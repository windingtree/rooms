...
import { deleteProfile, readProfileByEmail } from '../../../_lib/data/profile'
import {
...
import { IBookingCollection, IRoomTypeDbRecordCollection, IRoomTypeCollection, IProfile } from '../../../_lib/types'
...
async function apiTestTearDown(requester: IProfile): Promise<void> {
  ...
  const profile = await readProfileByEmail(appConfig.API_TEST_EMAIL)
