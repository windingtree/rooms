...
import { IBookingDbRecord, IBookingDbRecordCollection } from '../../../_lib/types'
...
async function readBookingsByOwnerId(ownerId: string): Promise<IBookingDbRecordCollection> {
